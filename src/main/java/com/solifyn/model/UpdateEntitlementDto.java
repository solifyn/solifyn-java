...
public class UpdateEntitlementDto {
  ...
  public UpdateEntitlementDto() {
  }

  public UpdateEntitlementDto name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateEntitlementDto type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateEntitlementDto githubRepo(@javax.annotation.Nullable String githubRepo) {
  ...
  public UpdateEntitlementDto githubPermission(@javax.annotation.Nullable String githubPermission) {
  ...
  public UpdateEntitlementDto discordGuildId(@javax.annotation.Nullable String discordGuildId) {
  ...
  public UpdateEntitlementDto discordRoleId(@javax.annotation.Nullable String discordRoleId) {
  ...
  public UpdateEntitlementDto framerTemplateId(@javax.annotation.Nullable String framerTemplateId) {
  ...
  public UpdateEntitlementDto licenseKey(@javax.annotation.Nullable String licenseKey) {
  ...
  public UpdateEntitlementDto activationLimit(@javax.annotation.Nullable BigDecimal activationLimit) {
  ...
  public UpdateEntitlementDto activationMessage(@javax.annotation.Nullable String activationMessage) {
  ...
  public UpdateEntitlementDto expiryHours(@javax.annotation.Nullable BigDecimal expiryHours) {
  ...
  public UpdateEntitlementDto digitalLink(@javax.annotation.Nullable String digitalLink) {
  ...
  public UpdateEntitlementDto instructions(@javax.annotation.Nullable String instructions) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEntitlementDto updateEntitlementDto = (UpdateEntitlementDto) o;
    return Objects.equals(this.name, updateEntitlementDto.name) &&
        Objects.equals(this.type, updateEntitlementDto.type) &&
        Objects.equals(this.githubRepo, updateEntitlementDto.githubRepo) &&
        Objects.equals(this.githubPermission, updateEntitlementDto.githubPermission) &&
        Objects.equals(this.discordGuildId, updateEntitlementDto.discordGuildId) &&
        Objects.equals(this.discordRoleId, updateEntitlementDto.discordRoleId) &&
        Objects.equals(this.framerTemplateId, updateEntitlementDto.framerTemplateId) &&
        Objects.equals(this.licenseKey, updateEntitlementDto.licenseKey) &&
        Objects.equals(this.activationLimit, updateEntitlementDto.activationLimit) &&
        Objects.equals(this.activationMessage, updateEntitlementDto.activationMessage) &&
        Objects.equals(this.expiryHours, updateEntitlementDto.expiryHours) &&
        Objects.equals(this.digitalLink, updateEntitlementDto.digitalLink) &&
        Objects.equals(this.instructions, updateEntitlementDto.instructions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEntitlementDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEntitlementDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEntitlementDto is not found in the empty JSON string", UpdateEntitlementDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEntitlementDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEntitlementDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEntitlementDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEntitlementDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEntitlementDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEntitlementDto.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEntitlementDto>() {
           @Override
           public void write(JsonWriter out, UpdateEntitlementDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEntitlementDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEntitlementDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEntitlementDto
   * @throws IOException if the JSON string is invalid with respect to UpdateEntitlementDto
   */
  public static UpdateEntitlementDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEntitlementDto.class);
  }

  /**
   * Convert an instance of UpdateEntitlementDto to an JSON string
   *
   * @return JSON string
   */
